...
import { MessageCircle, SendHorizontal, Heart } from "lucide-react"
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={(open) => setIsDialogOpen(open)}>
      <DialogTrigger asChild>
        <MessageCircle className='w-4 sm:w-5 text-gray-600 sm:text-gray-700 cursor-pointer' fill='white' />
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px] rounded-sm">
        ...
        <CommentCard comments={comments} commentUser={commentUser} messageId={messageId} likedBy={likedBy} />
